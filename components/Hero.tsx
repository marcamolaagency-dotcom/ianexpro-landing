    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-dark-900 pt-20 pb-16">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-10 font-light leading-relaxed">
          El único programa <strong className="text-white font-semibold">100% Práctico y en Directo</strong>. 
          Deja de ver tutoriales grabados. Construye 7+ artefactos funcionales con IA 
          mientras un experto te guía en tiempo real.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <div className="text-gray-400 text-sm font-medium">
            ⚠️ Solo 10 plazas disponibles
          </div>
        </div>

        {/* Tech Stack Strip */}
        <div className="mt-20 pt-10 border-t border-white/5">
          <p className="text-gray-500 text-sm uppercase tracking-widest mb-6">Tecnologías que dominarás</p>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
             ...
             <span className="text-xl font-bold flex items-center gap-2"><span className="text-green-500 text-2xl">●</span> GPT-4o</span>
             <span className="text-xl font-bold flex items-center gap-2"><span className="text-blue-400 text-2xl">◈</span> Perplexity.ai</span>
